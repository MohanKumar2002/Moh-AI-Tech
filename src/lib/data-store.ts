...
export let teamMembersData: Map<string, TeamMember> = new Map([
  ['mohan-kumar', {
    ...
    imageUrl: '/images/team/mohan-kumar.jpg',
  }],
  ['priya-sharma', {
    id: 'priya-sharma',
  ...
  ['anita-desai', {
    ...
    imageUrl: '/images/team/anita-desai.jpg',
...
export let productsData: Map<string, Product> = new Map([
  ['resume-builder', {
    ...
    imageUrl: '/images/products/resume-builder.jpg',
    subscriptionOptions: [
  ...
  ['smart-chatbot', {
    ...
    imageUrl: '/images/products/smart-chatbot.jpg',
    subscriptionOptions: [
  ...
  ['video-generator', {
    ...
    iconName: 'Video',
    imageUrl: '/images/products/video-generator.jpg',
    subscriptionOptions: [
  ...
  ['ocr-engine', {
    ...
    iconName: 'ScanText',
    imageUrl: '/images/products/ocr-engine.jpg',
    subscriptionOptions: [
  ...
  ['text-summarizer', {
    ...
    iconName: 'AlignLeft',
    imageUrl: '/images/products/text-summarizer.jpg',
    subscriptionOptions: [
