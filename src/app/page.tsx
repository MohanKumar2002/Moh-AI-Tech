...
export default function HomePage() {
  ...
  const exploreProductsText = t({ en: "Explore Our Products", ta: "எங்கள் தயாரிப்புகளை ஆராயுங்கள்" });
    ...
    <div className="space-y-16">
      <section className="text-center py-16 bg-gradient-to-br from-primary/10 via-background to-accent/10 rounded-lg shadow-sm">
        ...
        <p className="max-w-2xl mx-auto text-foreground mb-8">
          {t({
            en: "At Moh-AI Tech, we harness the power of artificial intelligence to build innovative tools that drive efficiency, foster creativity, and unlock new possibilities for businesses and individuals alike.",
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardHeader className="items-center text-center">
              ...
              <CardTitle className="font-headline">{t({en: "Innovation at Core", ta: "மையத்தில் புதுமை"})}</CardTitle>
            </CardHeader>
          ...
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardHeader className="items-center text-center">
              ...
              <CardTitle className="font-headline">{t({en: "Intelligent Solutions", ta: "நுண்ணறிவு தீர்வுகள்"})}</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-muted-foreground">
                {t({
                  en: "Our products are designed with deep intelligence to understand your needs and provide smart, effective results.",
                  ta: "எங்கள் தயாரிப்புகள் உங்கள் தேவைகளைப் புரிந்துகொண்டு புத்திசாலித்தனமான, பயனுள்ள முடிவுகளை வழங்க ஆழமான நுண்ணறிவுடன் வடிவமைக்கப்பட்டுள்ளன."
                })}
              </p>
            </CardContent>
          </Card>
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardHeader className="items-center text-center">
              ...
              <CardTitle className="font-headline">{t({en: "User-Centric Design", ta: "பயனர் மைய வடிவமைப்பு"})}</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-muted-foreground">
                {t({
                  en: "We prioritize user experience, ensuring our tools are intuitive, easy to use, and deliver tangible value.",
      ...
      <section className="text-center py-12 bg-card rounded-lg shadow-sm">
        <h2 className="text-3xl font-headline font-semibold mb-6">
          {t({en: "Our Flagship Products", ta: "எங்கள் முதன்மை தயாரிப்புகள்"})}
        </h2>
        <p className="max-w-xl mx-auto text-muted-foreground mb-8">
          {t({
            en: "Discover a suite of AI-powered tools designed to enhance productivity and creativity.",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
         ...
         <div className="mt-8">
            <Button variant="outline" asChild>
                <Link href="/products">{t({en: "View All Products", ta: "அனைத்து தயாரிப்புகளையும் காண்க"})}</Link>
            </Button>
        </div>
      </section>
