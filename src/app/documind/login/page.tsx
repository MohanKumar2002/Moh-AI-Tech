...
export default function DocuMindLogin() {
  return (
    <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center bg-[#FDFBFE] p-6 relative overflow-hidden font-sans">
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-[14px] text-gray-500">Pick up where you left off.</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-[14px] text-gray-500">
            New here? <Link href="/documind/signup" className="text-[#7C3AED] font-medium hover:underline">Create one</Link>
          </p>
        </div>
      </motion.div>
