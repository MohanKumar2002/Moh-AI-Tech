  ...
  return (
    <form ref={formRef} action={formAction} className="space-y-6 max-w-2xl">
      ...
      <div>
        ...
        <Input id="imageUrl" name="imageUrl" type="url" defaultValue={initialData?.imageUrl || ''} placeholder="https://example.com/image.png or /images/team/filename.jpg" required/>
